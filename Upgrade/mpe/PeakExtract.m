...
% Last modified: 3/15/2016  (Shivam Sharma, IIITS)
...
%     legend('Spectrum', 'Global Threshold (const)', 'Smoothed', 'Local Threshold (smoothed)');
end
...
if IfPlot
    ...
    legend('Spectrum', 'Global Threshold (const)', 'Smoothed', 'Local Threshold (smoothed)', 'Peaks');
